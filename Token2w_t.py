...
dataset = []
for i in range(4):            
    openfile = open("./Project/NLp_Project/sentence2w_t" + str(i)+".txt","r", encoding='utf-8-sig')
...
for j, x in enumerate(word):
    openout = open("./Project/NLp_Project/laura2w_t"+str(j)+".txt","w",encoding='utf-8-sig')
    for z in x:  
